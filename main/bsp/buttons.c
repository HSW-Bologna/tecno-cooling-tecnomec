...
static keypad_key_t keys[] = {
    KEYPAD_KEY(0x40, BSP_BUTTON_1), KEYPAD_KEY(0x02, BSP_BUTTON_2), KEYPAD_KEY(0x08, BSP_BUTTON_3),
    KEYPAD_KEY(0x80, BSP_BUTTON_4), KEYPAD_KEY(0x20, BSP_BUTTON_5), KEYPAD_KEY(0x01, BSP_BUTTON_6),
    KEYPAD_KEY(0x04, BSP_BUTTON_7), KEYPAD_KEY(0x10, BSP_BUTTON_8), KEYPAD_NULL_KEY,
};
